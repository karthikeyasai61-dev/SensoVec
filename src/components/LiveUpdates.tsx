...
const DEFAULT_CARDS: LiveUpdateItem[] = [
  ...
  { id: "d2", title: "Training Drive Open", description: "Applications are now open for specialized training programs at leading autonomous systems companies.", imageUrl: "/student_male.png" },
