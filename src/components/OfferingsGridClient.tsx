...
const CATEGORY_COLORS: Record<string, { color: string; bg: string }> = {
  ...
  "Training Program": { color: "#10b981", bg: "rgba(16,185,129,0.1)" },
    ...
    <div onClick={() => setShareOpenId(null)}>
      ...
      <div style={{
        ...
        <div style={{ position: "relative", flex: "1 1 260px", maxWidth: "400px" }}>
          ...
          <input
            type="text"
            placeholder={category ? `Search ${category === "Internship" ? "training program" : category.toLowerCase()}s...` : "Search courses, training programs, services…"}
            value={search}
              ...
              return (
                <button key={cat} onClick={() => setActiveFilter(cat)}
                  style={{
                    ...
                    background: isActive ? (cat === "All" ? "var(--primary)" : cfg.bg) : "rgba(255,255,255,0.02)",
                    border: `1px solid ${isActive ? (cat === "All" ? "var(--primary)" : cfg.color) : "rgba(255,255,255,0.08)"}`,
                ...
                >
                  {cat === "All" ? "All Offerings" : `${cat === "Internship" ? "Training Program" : cat}s`}
                </button>
              );
            })}
          </div>
                ...
                {course.imageUrl && (
                 ...
                 <div style={{ flexGrow: 1, display: "flex", flexDirection: "column" }}>
                  <span className="offering-card-tag" style={{
                    ...
                    {cat === "Career" ? cat : `${cat === "Internship" ? "Training Program" : cat} • ${course.type}`}
                  </span>
