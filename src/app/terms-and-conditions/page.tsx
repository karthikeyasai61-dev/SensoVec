      ...
      <main className="container" style={{ padding: "4rem var(--spacing-sm) 6rem var(--spacing-sm)", flex: 1 }}>
        ...
        <ScrollReveal style={{ transitionDelay: "150ms" }}>
          <div className="glass-card" style={{ padding: "2.5rem", lineHeight: 1.7, color: "var(--text-secondary)", fontSize: "0.95rem" }}>
            ...
            <p style={{ marginBottom: "1.5rem" }}>
              You may be required to create an account to enroll in courses, workshops, or apply for internships. You agree to provide accurate, complete, and current information. You are solely responsible for maintaining the confidentiality of your account credentials.
            </p>
