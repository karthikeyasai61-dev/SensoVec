        ...
        <ScrollReveal style={{ transitionDelay: "150ms" }}>
          <div className="glass-card" style={{ padding: "2.5rem", lineHeight: 1.7, color: "var(--text-secondary)", fontSize: "0.95rem" }}>
            ...
            <p style={{ marginBottom: "1.5rem" }}>
              We collect information you provide directly to us when registering, such as your name, email address, phone number, and educational level. When applying for internships or careers, we collect resumes and optional portfolio links.
            </p>
            ...
            <ul style={{ paddingLeft: "1.5rem", marginBottom: "1.5rem" }}>
              ...
              <li>Process and review applications for internships and careers.</li>
            ...
            <p style={{ marginBottom: "1.5rem" }}>
              We do not sell or rent your personal information to third parties. We may share applications and resumes with hiring partners or corporate sponsors when you explicitly apply for career roles or internships.
            </p>
