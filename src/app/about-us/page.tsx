          ...
          <ScrollReveal className={styles.reveal} style={{ width: "100%" }}>
            <div className={styles.servicesCard} style={{ height: "100%" }}>
              ...
              <p className={styles.servicesText}>
                Along with training programs and internships, we also undertake client-based projects and
          ...
          <ScrollReveal className={styles.reveal} style={{ width: "100%", transitionDelay: "200ms" }}>
            <div className={styles.servicesCard} style={{ height: "100%" }}>
              ...
              <p className={styles.servicesText}>
                ...
                internship experience, or bring a technical idea to life, we aim to provide the right guidance,
          ...
          <ScrollReveal className={styles.reveal} style={{ width: "100%", transitionDelay: "200ms" }}>
            <div className={`${styles.card} ${styles.missionCard}`} style={{ height: "100%" }}>
              ...
              <div className={styles.cardBody}>
                ...
                providing hands-on training, real-time projects, internships, mentorship, and technology-driven
